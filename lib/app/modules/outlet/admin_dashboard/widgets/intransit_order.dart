...
class IntransitOrder extends StatelessWidget {
  const IntransitOrder({super.key, required this.adminDashboardController});
      ...
      child: Column(
        children: [
          Container(
            ...
            child: Obx(() => adminDashboardController.deliveredOrder.isNotEmpty
                ? ListView.builder(
                    itemCount: adminDashboardController.deliveredOrder.length,
                    shrinkWrap: true,
                    itemBuilder: (ctx, i) {
                      return Card(
                        elevation: 10,
                                  ...
                                  RichText(
                                    text: TextSpan(
                                      ...
                                      children: [
                                        TextSpan(
                                          text:
                                              "₹${adminDashboardController.deliveredOrder.reversed.toList()[i]!.amount}/-",
                                          style: const TextStyle(
                                            color: Colors.red,
                                            fontSize: 12,
                                          ),
