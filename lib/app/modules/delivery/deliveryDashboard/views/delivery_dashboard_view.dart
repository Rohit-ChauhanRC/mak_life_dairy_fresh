...
import 'package:mak_life_dairy_fresh_delivery/app/widgets/delivery_drawer.dart';
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Text("${openOrders.orderDate}", style:
                                    TextStyle(fontSize: 12,fontWeight: FontWeight.bold,color: blackColor),)
                                  ],),
                                SizedBox(height: 8,),
                                Row(
                                  ...
                                  children: [
                                    ...
                                    TextStyle(fontSize: 14,fontWeight: FontWeight.bold,color: blackColor),),
                                    Text("₹ ${openOrders.payAmount}", style:
                                    TextStyle(fontSize: 16,fontWeight: FontWeight.bold,color: blackColor),)
                                  ],),
                                Text("${openOrders.address} ${openOrders.city} ${openOrders.statename} ${openOrders.pin}",
